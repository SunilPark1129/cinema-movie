...
const AsideOption = () => {
    ...
    const [isLimitedAsideWidth, setLimitedAsideWidth] = useState(), [hasReachedFooter, setReachedFooter] = useState(false), [genreIdx, setGenreIdx] = useState(0), [displayOption, setDisplayOption] = useState(false), [optionURL, setOptionURL] = useState(""), [requestURL, setRequestURL] = useState(null);
    ...
    const scroller = () => {
        window.scrollY >
            document.documentElement.scrollHeight - document.body.offsetHeight - 150 ?
    ...
    const resizer = () => {
        window.innerWidth > 1040 ?
            setLimitedAsideWidth(true) :
            setLimitedAsideWidth(false);
    };
